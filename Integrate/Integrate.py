...
from Algorithms.DesignToolAlgorithmV2.EXTRAS.joinBlocks import jointBlock
from Algorithms.DesignToolAlgorithmV2.BoundaryConditions.FormBoundaryConditionInformation import FormBoundaryConditionInformation
class Integrate():
